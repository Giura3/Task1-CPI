...
#define  PANEL_TEMPERATURA_AFARA          9       /* control type: scale, callback function: (none) */
#define  PANEL_ACT_PERTURBATIE            10      /* control type: textButton, callback function: activare_Perturbatie */
#define  PANEL_ACT_COMPENSARE             11      /* control type: textButton, callback function: activare_Compensare */
#define  PANEL_ACT_SIMULARE_RT            12      /* control type: ring, callback function: activare_simulare_RT */
